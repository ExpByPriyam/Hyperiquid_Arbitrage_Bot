...
def bot():
    ...
    positions1, im_in_pos1, pos_size1, pos_sym1, entry_px1, pnl_perc1, long1 = n.get_position(
        sym1)
    positions2, im_in_pos2, pos_size2, pos_sym2, entry_px2, pnl_perc2, long2 = n.get_position(
        sym2)
